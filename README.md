...
- This tool is designed to map this
  [GCF data](https://drive.google.com/drive/folders/1FBia9JzpdaCjRe7M7-pgh3Ahl9_MReh_)
...
uv run pip install dist/gcf_data_mapper-<version>-py3-none-any.whl
```

Goto the
[releases page](https://github.com/climatepolicyradar/gcf-data-mapper/releases)
...
If GCF updates are required, the following files need to be updated in the
`data/` folder:
...
`https://www.greenclimate.fund/export/MCFprojects.csv`. As it concerns the other
two files, please contact the GCF team directly.
